 ...
 */
class CRM_Inboundemailnotification_Upgrader_Base {

  /**
   * @var CRM_Inboundemailnotification_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Inboundemailnotification_Upgrader(
        'biz.jmaconsulting.inboundemailnotification',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Inboundemailnotification_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Inboundemailnotification_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
